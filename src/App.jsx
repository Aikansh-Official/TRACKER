...
export default function App() {
  ...
  const modal = showModal && <RoutineComposer form={form} setForm={setForm} error={formError} onSubmit={createTask} onClose={() => setShowModal(false)} />;
